...
const { passwordUpdated } = require('../mailTemplates/passwordUpdateEmail.js');
...
exports.signUp = async (req, res) => {
    try {
        ...
        let approved = "";
        accountType === "Provider" ? (approved = false) : (approved = true);
    ...
    try {
        ...
        try {
            const emailResponse = await mailsender(
                    updatedUserDetails.email,
                    "Password Changed for Your ONETAP Account",
                    passwordUpdated(
                        updatedUserDetails.email,
                        `Password Updated Successfully for ${updatedUserDetails.firstName} ${updatedUserDetails.lastName}`
                    )
